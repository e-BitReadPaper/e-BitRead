...
def cdf_3(dir):
    for cachePol in [1]:
        ...
        plt.savefig(os.path.join(dir, "qoe_heuristic" + ".pdf"))
        plt.show()
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(dir, "rebuffering_heuristic.pdf"))
        fig3.show()
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(dir, "bitratevariation_heuristic.pdf"))
        fig4.show()
...
def main():
    ...
    dir = "../data/RL_model/2024-12-19_14-30-50/test_trace_multi_client_2/HSDPA_test_heuristic"
    # cdf_1(dir)
    # cdf_2(dir)
    cdf_3(dir)
    plt.show()
